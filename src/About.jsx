...
function About({ setPlayState }) { // Destructure setPlayState from props
  return (
    <div>
      <div className="about">
        ...
        <div className="about-right"> {/* Corrected the typo "about-reight" */}
          <h3>ABOUT UNIVERSITY</h3> {/* Corrected the typo "UNIVERCITY" */}
